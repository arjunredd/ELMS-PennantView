...
import com.avanse.models.TrnPaymentRequestHistory;
import com.avanse.models.TrnPaymentRequestHistoryRepository;
...
public class EncryptDecryptFilter implements Filter{
	...
	@Override public void doFilter(ServletRequest request, ServletResponse
		...
		if(!"".equals(body)){
			...
			TrnPaymentRequestHistory trh=new TrnPaymentRequestHistory(decryptedData, responseData, "ELMSPENNANTVIEWS_REQUEST");
